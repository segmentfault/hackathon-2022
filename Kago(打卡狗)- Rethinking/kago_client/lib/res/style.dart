...
class Styles {
  ...
  static const TextStyle styleNoteBlack32 = TextStyle(color: ColorStyle.colorNote202020, fontSize: 32);    
  static const TextStyle styleNoteBlack14 = TextStyle(color: ColorStyle.colorNote7E7E7E, fontSize: 14);    

  static const TextStyle styleNoteText12 = TextStyle(color: ColorStyle.colorNote949494, fontSize: 12);    
  static const TextStyle styleNoteText14 = TextStyle(color: ColorStyle.colorNote202020, fontSize: 16, fontFamily: 'ShouShuti');    
  static const TextStyle styleNoteComm12 = TextStyle(color:  Color.fromRGBO(126,126,126,1), fontSize: 12);    
