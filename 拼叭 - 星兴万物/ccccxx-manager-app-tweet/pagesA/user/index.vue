<template>
	<view class="page-bg">
		<comHead hideBack changeColor>我的主页</comHead>
    ...
    <view class="coupon-tip" @click="gotoLaxin">
...
<!-- 		<view class="invite-card">
			<view class="invite-card-t">邀请拉新</view>
			<view class="flex-c">
				<view class="invite-item">
					<view class="invite-item-n">{{ userNum.today || 0 }}</view>
					<view class="invite-item-t">当日拉新</view>
				</view>
				<view class="invite-item">
					<view class="invite-item-n">{{ userNum.month || 0 }}</view>
					<view class="invite-item-t">当月拉新</view>
				</view>
				<view class="invite-item">
					<view class="invite-item-n">{{ userNum.all || 0 }}</view>
					<view class="invite-item-t">累计拉新</view>
				</view>
			</view>

			<image @click="gotoLaxin" class="invite-btn"
				src="https://basic-1258404477.cos.ap-nanjing.myqcloud.com/user/invite-btn.png" mode=""></image>
		</view> -->
...
export default {
  ...
  methods: {
    ...
    //   return {
    //     title: "拼叭｜组人组局用拼叭",
    //     path: `/pagesA/user/index?shareUserId=${this.myUserId}&isHome=1`,
    //   };
    // },
    queryUserInfo() {
