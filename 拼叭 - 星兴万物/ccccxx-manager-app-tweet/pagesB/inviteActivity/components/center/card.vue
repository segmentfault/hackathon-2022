        ...
        >
          ...
          <view class="center">
            <view class="title">{{ item.companyName }}</view>
						<view class="tags" v-if="item.marks.length">{{item.marks[0]}}</view>
						<view class="address" @click.stop="openLocation(item)">
						  <image
						    class="icon"
						    src="https://image-1306191496.cos.ap-nanjing.myqcloud.com/9e59b8ce-e20d-4cf2-8af6-eab5057c686c.png"
						  ></image>
