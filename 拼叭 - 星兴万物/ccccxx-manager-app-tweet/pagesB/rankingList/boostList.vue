		...
		<view class="rank-list">
			<template v-if="list && list.length">
				<view class="line-item" :key="i" v-for="(item, i) in list">
					...
					<view class="r-bg">
						<view class="flex-s">
							<view class="l-name">{{ item.nickName }}
								<image v-if="item.isNew" src="https://image-1306191496.cos.ap-nanjing.myqcloud.com/f54c59e0-43d5-4221-9fd7-59b805d2971f.png" />
								<image v-if="!item.isNew"
									src="https://image-1306191496.cos.ap-nanjing.myqcloud.com/b2d824e3-7ab5-46b1-a0cf-049e30ae55e1.png" />
							</view>
							<view class="r-val flex-c">
								<image class="fire"
									src="https://basic-1258404477.cos.ap-nanjing.myqcloud.com/rank/fire.png" mode="">
								</image>+{{ item.popularity }}
							</view>
						</view>
						<view class="flex-s">
							<view class="l-from">来自{{ zlFrom[item.boostSource] }}“给TA助力”</view>
							<view class="r-time">
								{{
