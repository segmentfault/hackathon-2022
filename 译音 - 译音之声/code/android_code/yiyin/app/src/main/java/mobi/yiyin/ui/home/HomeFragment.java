...
import mobi.yiyin.R;
import mobi.yiyin.arglass.ARGlassActivity;
...
public class HomeFragment extends Fragment implements View.OnClickListener {
    ...
    private void initView(View root) {
        ...
        root.findViewById(R.id.lv_ar_glass).setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.lv_ai_subtitle:
                ...
                break;
            case R.id.lv_ar_glass:
                startActivity(new Intent(getContext(), ARGlassActivity.class));
                break;
            case R.id.lv_hand:
