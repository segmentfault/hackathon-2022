...
public class MainActivity extends BaseActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private void setApiKey() {
        ...
        // 设置api_key。
        MLApplication.getInstance().setApiKey("CwEAAAAAh00BEVHrAjSFnBxNdQfmFOk/r+ZqZWBbcOggvVwxE2ODGD4PIFyT6ldo0ncM4tCUjqwCB+w2p3gdPcZqzphP15Hw0SU=");
// 设置Access Token。
        MLApplication.getInstance().setAccessToken("361d1f7bdef26417652376fef3e26aa37f8a9bd74a86debed6679fcfe26682a2");
