    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          ListView.builder(
              padding:
                  EdgeInsets.only(left: 12, top: 12, right: 12, bottom: 144),
...
class SigninItem extends StatelessWidget {
  final bool isSender;
  final String text;
  const SigninItem({Key? key, required this.isSender, required this.text})
      : super(key: key);
      ...
      children: [
        ...
        Container(
          ...
          decoration: DecorationStyle.customizeBorder(
                  radius: 15, color: Color.fromRGBO(0, 153, 255, 1))
              .copyWith(color: Color.fromRGBO(0, 153, 255, 1)),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.start,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
...
class ChatItem extends StatelessWidget {
  ...
  const ChatItem({Key? key, required this.isSender, required this.item})
      : super(key: key);
