...
export default class Index extends React.Component{
    ...
    onFinish=({OilName,OilPrice,OilUrl,From,Details,Fee,Types,Days})=>{
        api.addOil()({OilName,OilPrice,OilUrl,From,Details,Fee,Types,Days})
            .then(res=>res.json())
            .then(result=>{
