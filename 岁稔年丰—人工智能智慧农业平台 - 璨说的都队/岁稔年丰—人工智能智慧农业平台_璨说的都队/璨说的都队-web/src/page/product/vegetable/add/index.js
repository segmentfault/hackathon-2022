...
export default class Index extends React.Component{
    ...
    onFinish=({VegetableName,VegetablePrice,VegetableUrl,From,Details,Fee,Types,Days})=>{
        api.addVegetable()({VegetableName,VegetablePrice,VegetableUrl,From,Details,Fee,Types,Days})
            .then(res=>res.json())
            .then(result=>{
