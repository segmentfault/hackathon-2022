...
export default class Index extends React.Component{
    ...
    onFinish=({FruitName,FruitPrice,FruitUrl,From,Details,Fee,Types,Days})=>{
        api.addFruit()({FruitName,FruitPrice,FruitUrl,From,Details,Fee,Types,Days})
            .then(res=>res.json())
            .then(result=>{
