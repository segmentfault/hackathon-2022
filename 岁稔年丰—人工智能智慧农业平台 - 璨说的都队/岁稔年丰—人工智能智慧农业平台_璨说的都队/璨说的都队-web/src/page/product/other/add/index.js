...
export default class Index extends React.Component{
    ...
    onFinish=({OtherName,OtherPrice,OtherUrl,From,Details,Fee,Types,Days})=>{
        api.addOther()({OtherName,OtherPrice,OtherUrl,From,Details,Fee,Types,Days})
            .then(res=>res.json())
            .then(result=>{
