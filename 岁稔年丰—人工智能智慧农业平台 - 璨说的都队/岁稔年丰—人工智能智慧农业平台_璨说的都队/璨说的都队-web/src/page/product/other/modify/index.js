...
export default class Index extends React.Component{
    ...
    onFinish=({ProdId,OtherName,OtherPrice,OtherUrl,Days,From,Details,Fee,Types})=>{
        OtherName = this.ProdTitle;
        ProdId = this.ProdId;
        OtherPrice = this.ProdPrice;
        OtherUrl = this.ProdUrl;
        Days = this.ProdDays;
        Details = this.ProdDetails;
        Fee = this.ProdFee;
        From = this.ProdFrom;
        Types = this.ProdTypes;
        api.updataOther({OtherName,OtherPrice,OtherUrl,Days,From,Details,Fee,Types})(ProdId)
            .then(res=>res.json())
            .then(result=>{
