...
export default class Index extends React.Component{
    ...
    onFinish=({ProdId,MeatName,MeatPrice,MeatUrl,Days,From,Details,Fee,Types})=>{
        MeatName = this.ProdTitle;
        ProdId = this.ProdId;
        MeatPrice = this.ProdPrice;
        MeatUrl = this.ProdUrl;
        Days = this.ProdDays;
        Details = this.ProdDetails;
        Fee = this.ProdFee;
        From = this.ProdFrom;
        Types = this.ProdTypes;
        api.updataMeat({MeatName,MeatPrice,MeatUrl,Days,From,Details,Fee,Types})(ProdId)
            .then(res=>res.json())
            .then(result=>{
