...
export default class Index extends React.Component{
    ...
    onFinish=({ProdId,RecommeadName,RecommeadPrice,RecommeadUrl,Days,From,Details,Fee,Types})=>{
        RecommeadName = this.ProdTitle;
        ProdId = this.ProdId;
        RecommeadPrice = this.ProdPrice;
        RecommeadUrl = this.ProdUrl;
        Days = this.ProdDays;
        Details = this.ProdDetails;
        Fee = this.ProdFee;
        From = this.ProdFrom;
        Types = this.ProdTypes;
        api.updataRecommead({RecommeadName,RecommeadPrice,RecommeadUrl,Days,From,Details,Fee,Types})(ProdId)
            .then(res=>res.json())
            .then(result=>{
                this.showSuccessResultc();
                this.props.history.push('/recommead');
            }).catch(e=>{
            console.log(e)
