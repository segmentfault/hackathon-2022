...
export default class Index extends React.Component{
    ...
    onFinish=({RecommeadName,RecommeadPrice,RecommeadUrl,From,Details,Fee,Types,Days})=>{
        api.addRecommead()({RecommeadName,RecommeadPrice,RecommeadUrl,From,Details,Fee,Types,Days})
            .then(res=>res.json())
            .then(result=>{
