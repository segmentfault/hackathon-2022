...
public class Scroll_menu_Grid_Adapter extends BannerAdapter<Scroll_menu_Grid_Bean, Scroll_menu_Grid_Adapter.BannerViewHolder>  {
    public Scroll_menu_Grid_Adapter(List<Scroll_menu_Grid_Bean> mDatas) {
    ...
    @Override
    public void onBindView(BannerViewHolder holder, Scroll_menu_Grid_Bean data, final int position, int size) {
