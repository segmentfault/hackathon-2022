...
public class Craft_Banner_Adapter extends BannerAdapter<Craft_Banner_Bean, Craft_Banner_Adapter.BannerViewHolder> {
    public Craft_Banner_Adapter(List<Craft_Banner_Bean> mDatas) {
    ...
    @Override
    public void onBindView(BannerViewHolder holder, Craft_Banner_Bean data, final int position, int size) {
