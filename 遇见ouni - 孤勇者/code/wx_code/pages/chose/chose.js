...
Page({
          ...
          if (that.data.img_arr.length == images_list.length) {
            ...
            if (images_list.length == 3) {
              dataUrl = {
                ...
                goodsUrl2: images_list[1].data,
                goodsUrl3: images_list[2].data,
              };
            }
  ...
  upimg: function () {
    ...
    if (this.data.img_arr.length < 3) {
      wx.chooseImage({
        ...
        success(res) {
          console.log(that.data.img_arr.concat(res.tempFilePaths));
          that.setData({
  ...
  onLoad : function(){
    let commoditydetails = wx.getStorageSync("commoditydetails");
    console.log(commoditydetails)
    this.setData({
      text:commoditydetails.goodsDetail,
      address:commoditydetails.goodsAdd,
      price:commoditydetails.goodsPrice
    });
    // this.setData({
    //     images_list:wx.getStorageInfoSync("img_arr")
    // })
  },
