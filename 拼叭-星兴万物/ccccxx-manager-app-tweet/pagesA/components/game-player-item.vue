<template>
  <view class="man-item" :class="{ card }">
    ...
    >
			<image src="https://image-1306191496.cos.ap-nanjing.myqcloud.com/bb0efde5-9b01-4f1e-8cd6-098b14cbdb7f.png" v-if="member.sex == 1"></image>
			<image src="https://image-1306191496.cos.ap-nanjing.myqcloud.com/6b966e81-2320-4fc0-ac43-c9bfabf5b149.png" v-else></image>
...
<!--        <view class="man-t" v-if="member.constellation !== 'undefined'">{{
      ...
      <view class="flex-s" style="margin-top: 14upx">
        <view class="flex-c interest-line" v-if="member.userId != -1">
          兴趣:
          <view
            class="interest"
